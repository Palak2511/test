...
(function($){
	...
	var Field = acf.Field.extend({
		...
		// 	acf.onFocus($layout, function( isFocused ){
		// 		isFocused ? $layout.addClass('is-selected') : $layout.removeClass('is-selected');
		// 	});
		// },

		// selectLayout: function( $layout ){
		// 	console.log('selectLayout', $layout);
		// 	$layout.trigger('acfFocus');
		// 	//$layout.addClass('is-selected');
		// },

		// deselectLayout: function( $layout ){
		// 	$layout.trigger('acfBlur');
		// 	//$layout.removeClass('is-selected')
		// },
		...
		add: function( args ){
			...
			// Initialize and select layout.
			//this.initializeLayout( $el );
			//this.selectLayout( $el );
		...
		duplicateLayout: function( $layout ){
			...
			// Initialize, select and draw focus to layout.
			//this.deselectLayout( $layout );
			//this.initializeLayout( $el );
			//this.selectLayout( $el );
			acf.focusAttention( $el );
