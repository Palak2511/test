...
(function($, undefined){
	...
	*/
	...
	var addSingleFieldAction = function( action ){
		...
		var modelCallback = acf.strCamelCase( 'on ' + action ); // onRemove
		...
		var singleCallback = function( field /*, arg1, arg2, etc*/ ){
			...
			if( singleFieldEvents.indexOf(action) > -1 ) {
				...
				// Call modelCallback when possible.
				// Currently unused until a solution is found to transition from "event parameters" (e, $el, param1) to "direct parameters" (param1).
				//if( typeof field[ modelCallback ] === 'function' ) {
				//	field[ modelCallback ].apply( field, extraArgs );
				//}
			}
		};
