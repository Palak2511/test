...
class ACF_Legacy_Locations {
	...
	public function __get( $key ) {
		...
		switch ( $key ) {
			case 'locations':
				return call_user_func( 'acf_get_location_rules' );
		}
		return null;
	}
	...
	public function __call( $name, $arguments ) {
		...
		switch ( $name ) {
			case 'register_location':
				return call_user_func_array( 'acf_register_location_rule', $arguments );
			case 'get_location':
				return call_user_func_array( 'acf_get_location_rule', $arguments );
			case 'get_locations':
