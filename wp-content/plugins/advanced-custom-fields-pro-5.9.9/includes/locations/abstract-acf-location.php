...
abstract class ACF_Location extends ACF_Legacy_Location {
	 ...
	 * @return	array
	 */
	public static function get_rule_operators( $rule ) {
		return array(
			'=='	=> __( "is equal to", 'acf' ),
	...
	public function match_rule( $rule, $screen, $field_group ) {
		$value = false;
		return $this->compare_rule( $rule, $value );
	}
	
	/**
	 * Compares the provided rule to a specific value returning a bool result.
	 *
	 * @date	17/9/19
	 * @since	5.8.1
	 *
	 ...
	 * @return	bool
	 */
	public function compare_rule( $rule, $value ) {
