...
add_action('wp_enqueue_scripts', 'twenty_twenty_one_scripts', 999);
...
add_action('woocommerce_before_shop_loop', 'wc_add_mixitup_filter');

function wc_add_mixitup_filter() {
    ...
    foreach ($all_categories as $cat) {
        $cat_html .= '<button class="filter-btn" data-filter=".product_cat-' . $cat->slug . '">' . $cat->name . ' (' . $cat->count . ')</button>';
    }
    ?>
    <div class="row">
